    ...
    try {
      ...
      if (fromCarrier) {
        ...
        if (!gateway) {
          ...
          }, 'identifyAccount: rejecting call from carrier because DID has not been provisioned');
        ...
        logger.info({
          ...
          callingNumber: req.callingNumber,
          sourceAddress: req.source_address
        }, `identifyAccount: incoming call from gateway - FROM: ${req.callingNumber} TO: ${req.calledNumber}`);
